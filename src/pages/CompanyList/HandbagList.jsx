...
// Custom hook to fetch Handbag companies
const useHandbagCompanies = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error("Error fetching Handbag data:", error);
      } finally {
        setLoading(false);
      }
    };
...
const HandbagCompanies = ({ search }) => {
  const { companies, loading } = useHandbagCompanies();
...
export default HandbagCompanies;
